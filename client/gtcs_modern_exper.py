...
sch_failure = []
'''
# 8 Carriages (no longer available)
for i in range(1, 9):
...
def render_gtcs():
    ...
    cdrawer(-160, 0, 80, lambda i: int(i // 2))
    turtle.goto(-160, 0)
    # turtle.circle(80, -60)
...
def render_gtcs_main():
    global onbat, batregen, ovrd_main_disp, gfailind, prelkj, light, caccel, prereded, curspeed, intervene_spd, acreqspd, spdlim, lastspdlim, accreq, gtcsinfo, sysinfo, thrust, eb, nextdist, failures, zusatz_lastspdlim, has_afb, passing, cars
    # print("GTCS Renderer")
    gaspress.clear()
    acreqer.hideturtle()
    acreqer.goto(-160, 0)
        ...
        for i in cars:
            ...
            for jt in i["failures"]["term"]:
                ...
                if j[1] or j[2](i):
                    ...
                    #print(i["failures"]["was_failure"],type(i["failures"]["was_failure"]))
...
def physics():
    global lastupdate_t, current_slope, tcnter1, intervene_spd, plog, contnz, caccel, limitz, accuer, curspeed, thrust, gtcsinfo, accreq, power, acreqspd, LEVEL, schutz, schutz_info, sysinfo, zusatz_lastspdlim, passing, PASSING_SPD, MONITOR_SPEED_DELTA, MONITOR_ACCEL, announced_sig, announcement_got, dendro_mass, dendro_feed, cpsrc
